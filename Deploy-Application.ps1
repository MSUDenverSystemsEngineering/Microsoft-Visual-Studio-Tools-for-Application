...
Try {
	...
	[string]$appName = 'Visual Studio Tools for Applications'
	[string]$appVersion = '2015'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '06/21/2021'
	[string]$appScriptAuthor = 'Jame Hardy'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\vsta_setup.exe" -Parameters "/S" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "$dirFiles\vsta_setup.exe" -Parameters "/Uninstall /S" -WindowStyle "Hidden" -PassThru
        If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
